...
{
    public partial class SuspendedRetrievalForm : Form
    {
        ...
        {
            string query = "SELECT transactionNumber, invoiceNumber, vendorName, dateTime, totalCost FROM Transactions WHERE isComplete= 0";
